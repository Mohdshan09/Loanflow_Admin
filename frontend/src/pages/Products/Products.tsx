...
import RuleMatrixModal from '../../components/products/RuleMatrixModal';
...
const Products = () => {
  ...
  const products: ProductType[] = data?.data ?? EMPTY_PRODUCTS;
  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <ProductHeader
        ...
        onRuleMatrix={() => setIsRuleMatrixOpen(true)}
      />
      ...
      {/* Rule Matrix Modal */}
      <RuleMatrixModal
        isOpen={isRuleMatrixOpen}
        onClose={() => setIsRuleMatrixOpen(false)}
        products={products}
      />
    </div>
  );

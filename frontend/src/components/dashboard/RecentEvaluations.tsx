    ...
    <section className="rounded-xl border border-slate-200 bg-white shadow-sm flex flex-col justify-between">
      ...
      <div className="flex items-center justify-between border-b border-slate-100 px-6 py-5">
        <div>
          ...
          <p className="mt-1 text-sm text-slate-500">Recently evaluated applicants</p>
        </div>
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-sm font-semibold text-slate-900">{ev.fullName}</p>
                      <p className="text-xs text-slate-400">
                        Score: {ev.creditScore} ·{' '}
                        {isEligible ? `${ev.eligibleProductsCount} product(s) match` : 'No match'}
                      </p>
                    </div>
                  </div>

      ...
      <div className="w-full max-w-2xl rounded-2xl bg-white shadow-2xl overflow-hidden border border-slate-100">
        ...
        <div className="flex items-center justify-between border-b border-slate-100 bg-slate-50/50 px-6 py-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg font-bold text-slate-900 leading-none">{product.name}</h2>
              <p className="mt-1 font-mono text-xs text-slate-400">ID: {product.id}</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            ...
            <div className="rounded-xl border border-slate-100 bg-slate-50/70 p-3">
              ...
              <p className="mt-1.5 text-sm font-bold text-slate-900">{product.minCreditScore}+</p>
            </div>

    ...
    <div className="flex flex-col gap-3 rounded-xl border border-slate-200 bg-white px-4 py-3 shadow-sm sm:flex-row sm:items-center sm:justify-between">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex items-center gap-2 rounded-lg border border-blue-200 bg-blue-50 px-3 py-1.5">
          <span className="text-sm font-semibold text-blue-700">All Products</span>
        ...
        <div className="flex items-center gap-1.5">
          <Radio size={11} className="animate-pulse text-emerald-500" strokeWidth={2} />
          <span className="text-xs font-medium text-slate-500">Realtime Evaluation Enabled</span>
        </div>
      </div>
